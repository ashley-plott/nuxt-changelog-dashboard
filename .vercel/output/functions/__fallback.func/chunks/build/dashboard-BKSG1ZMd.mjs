    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (vueExports.unref(pending)) {
        ...
        if (vueExports.unref(thisMonth).maintenance.length) {
          ...
          serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(thisMonth).maintenance.slice(0, 10), (s) => {
            _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
              key: s.id,
              to: `/site/${s.id}`,
          ...
          _push(`<!--]-->`);
          if (vueExports.unref(thisMonth).maintenance.length > 10) {
            _push(`<p class="text-xs text-gray-500">\u2026and ${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(thisMonth).maintenance.length - 10)} more</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        if (vueExports.unref(thisMonth).reports.length) {
          _push(`<div class="mt-3 space-y-2"><!--[-->`);
          serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(thisMonth).reports.slice(0, 10), (s) => {
            _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
              key: s.id,
              to: `/site/${s.id}`,
              class: "flex items-center justify-between rounded-lg border px-3 py-2 hover:bg-gray-50"
          ...
          _push(`<!--]-->`);
          if (vueExports.unref(thisMonth).reports.length > 10) {
            _push(`<p class="text-xs text-gray-500">\u2026and ${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(thisMonth).reports.length - 10)} more</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        if (vueExports.unref(thisMonth).renewals.length) {
          _push(`<div class="mt-3 space-y-2"><!--[-->`);
          serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(thisMonth).renewals.slice(0, 10), (s) => {
            _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
              key: s.id,
              to: `/site/${s.id}`,
              class: "flex items-center justify-between rounded-lg border px-3 py-2 hover:bg-gray-50"
          ...
          _push(`<!--]-->`);
          if (vueExports.unref(thisMonth).renewals.length > 10) {
            _push(`<p class="text-xs text-gray-500">\u2026and ${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(thisMonth).renewals.length - 10)} more</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(monthsOverview), (m) => {
          ...
          if (m.maintenance.length) {
            ...
            serverRenderer_cjs_prodExports.ssrRenderList(m.maintenance.slice(0, 4), (s) => {
              _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
                key: s.id,
                to: `/site/${s.id}`,
            ...
            _push(`<!--]-->`);
            if (m.maintenance.length > 4) {
              _push(`<div class="text-xs text-gray-500">\u2026and ${serverRenderer_cjs_prodExports.ssrInterpolate(m.maintenance.length - 4)} more</div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
          ...
          if (m.reports.length) {
            _push(`<div class="space-y-1"><!--[-->`);
            serverRenderer_cjs_prodExports.ssrRenderList(m.reports.slice(0, 4), (s) => {
              _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
                key: s.id,
                to: `/site/${s.id}`,
                class: "flex items-center justify-between rounded-lg border px-3 py-1.5 text-sm hover:bg-gray-50"
            ...
            _push(`<!--]-->`);
            if (m.reports.length > 4) {
              _push(`<div class="text-xs text-gray-500">\u2026and ${serverRenderer_cjs_prodExports.ssrInterpolate(m.reports.length - 4)} more</div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
          ...
          if (m.renewals.length) {
            _push(`<div class="space-y-1"><!--[-->`);
            serverRenderer_cjs_prodExports.ssrRenderList(m.renewals.slice(0, 4), (s) => {
              _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, {
                key: s.id,
                to: `/site/${s.id}`,
                class: "flex items-center justify-between rounded-lg border px-3 py-1.5 text-sm hover:bg-gray-50"
            ...
            _push(`<!--]-->`);
            if (m.renewals.length > 4) {
              _push(`<div class="text-xs text-gray-500">\u2026and ${serverRenderer_cjs_prodExports.ssrInterpolate(m.renewals.length - 4)} more</div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
...
//# sourceMappingURL=dashboard-BKSG1ZMd.mjs.map
