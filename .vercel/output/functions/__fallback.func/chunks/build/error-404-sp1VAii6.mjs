...
import { _ as _export_sfc, u as useHead } from './_plugin-vue_export-helper-BkUl7dT5.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-6ce9f070><div class="fixed left-0 right-0 spotlight z-10" data-v-6ce9f070></div><div class="max-w-520px text-center z-20" data-v-6ce9f070><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-6ce9f070>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-6ce9f070>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-6ce9f070>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.19.1_@parcel+watcher@2.5.1_@vue+compiler-sfc@3.5.21_db0@0.3.2_ioredis@5.7.0_magi_b2826bf653b4ea302dcdc389c3480be6/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6ce9f070"]]);

export { error404 as default };
//# sourceMappingURL=error-404-sp1VAii6.mjs.map
